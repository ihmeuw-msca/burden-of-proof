...
setwd(work_dir)
source("./config.R")
source("./src/utils/mixed_functions.R")

model_path <- "/ihme/code/qwr/ckd_qwr/evidence_score_pipeline/mrbrt_model_outputs/vmixed/stage3_str_bp_vmixed/mod1.pkl"
...
### Output diagnostics
title <- paste0("sim", ": egger_mean=", round(egger_model$mean, 3),
