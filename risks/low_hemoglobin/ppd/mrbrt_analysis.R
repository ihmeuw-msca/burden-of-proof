...
library(reticulate, lib.loc = "PATH TO PACKAGES")
Sys.setenv("RETICULATE_PYTHON" = "PATH TO PACKAGES")
library(mrbrt003, lib.loc = "PATH TO PACKAGES")
withr::local_libpaths("PATH TO PACKAGES", action = "prefix")
library(data.table)
library(checkmate)

run_mrbrt <- function(input_df){
