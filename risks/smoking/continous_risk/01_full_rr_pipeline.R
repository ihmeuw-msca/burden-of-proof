...
if(interactive()){
  ro_pair <- "enter risk outcome pair here" # e.g., cataracts
...
py_save_object(object = signal_model, 
               filename = paste0(out_dir, "01_template_pkl_files/", ro_pair, "_knots_", N_I_KNOTS, sens, ".pkl"), 
               pickle = "dill")

out <- append(data, list(df_data=df_data))
saveRDS(out, paste0(out_dir, "01_template_models/", ro_pair, "_knots_", N_I_KNOTS, sens, ".RDS"))
...
data <- readRDS(paste0(out_dir, "01_template_models/", ro_pair, "_knots_", N_I_KNOTS, sens, ".RDS"))
...
py_save_object(object = model, 
               filename = paste0(out_dir, "02_loglinear_pkl_files/", ro_pair, "_knots_", N_I_KNOTS, sens, ".pkl"), 
               pickle = "dill")

out <- append(data, list(beta_std = beta_std))
saveRDS(out, paste0(out_dir, "02_loglinear_models/", ro_pair, "_knots_", N_I_KNOTS, sens, ".RDS"))
...
# Read data
data <- readRDS(paste0(out_dir, "02_loglinear_models/", ro_pair, "_knots_", N_I_KNOTS, sens, ".RDS"))
df_data <- data$df_data
df_tmp <- data$df
...
loglinear_model <- readRDS(paste0(out_dir, "02_loglinear_models/", ro_pair, "_knots_", N_I_KNOTS,sens, ".RDS"))
...
saveRDS(out, paste0(out_dir, "03_covariate_selection_models/", ro_pair, "_knots_", N_I_KNOTS,sens, ".RDS"))
...
data <- readRDS(paste0(out_dir, "03_covariate_selection_models/", ro_pair, "_knots_", N_I_KNOTS,sens, ".RDS"))
...
signal_model <- py_load_object(filename=paste0(out_dir, "01_template_pkl_files/", ro_pair, "_knots_", N_I_KNOTS,sens, ".pkl"), 
                               pickle = "dill")
orig_data <- readRDS(paste0(out_dir, "01_template_models/", ro_pair, "_knots_", N_I_KNOTS,sens, ".RDS"))
df <- orig_data$df
...
py_save_object(object = model, 
               filename = paste0(out_dir, "04_mixed_effects_pkl_files/", ro_pair, "_knots_", N_I_KNOTS,sens, ".pkl"), 
               pickle = "dill")
